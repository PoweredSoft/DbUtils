...
namespace psdb_ext
{
    ...
    internal sealed class InitCommand
    {
        ...
        private InitCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static InitCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in InitCommand's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync((typeof(IMenuCommandService))) as OleMenuCommandService;
            Instance = new InitCommand(package, commandService);
        }
            ...
            if (dte != null)
            {
                ...
                if (null != selectedItems)
                {
                    ...
                    foreach (UIHierarchyItem selItem in selectedItems)
                    {
                        ...
                        projectName = prjItem.ContainingProject.Name;
                        directory = prjItem.Properties.Item("FullPath").Value.ToString(); 
                        break;
                    }
